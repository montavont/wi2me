 ...
 *
 */
public class BLEWriteCounterToCharacteristicCommand extends WirelessNetworkCommand{
	...
	public BLEWriteCounterToCharacteristicCommand(HashMap<String, String> params)
	{
		m_params = params;
	...
	{
		String charValue = String.format(Locale.US, "%d", counter);
