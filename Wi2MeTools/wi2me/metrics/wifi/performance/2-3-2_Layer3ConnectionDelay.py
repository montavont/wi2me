...
from wi2me.model.ConnectionEvent import TYPE_CONNECTION_START, TYPE_CONNECTED

METRIC_CODE = "2.3.2"
METRIC_NAME = "Layer Three connection delay"
OUT_BASE_NAME = "Layer3ConnectionDelay.svg"
...
def plot(config):
	...
	for source in config['data']:
		...
		for event in source.getEvents( [TYPE_CONNECTION_START, TYPE_CONNECTED]):
	...
	plt.ylabel("CDF")
	plt.xlabel("Layer 3 connection times (ms)")
