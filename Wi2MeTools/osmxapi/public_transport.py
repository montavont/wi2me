...
public_transport_platform = XapiQuery(public_transport = u"platform")
public_transport_station = XapiQuery(public_transport = u"station")
public_transport_stop_position = XapiQuery(public_transport = u"stop_position")
