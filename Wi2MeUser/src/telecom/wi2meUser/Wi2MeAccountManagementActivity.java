				...
				try {
					...
					if(operator_trans.equals("") || login_get.equals("") || password_get.equals("") ){
						...
						builder.setPositiveButton("Yes", new OnClickListener(){
							...
							List<CommunityNetwork> communityNets = (List<CommunityNetwork>) binder.parameters.getParameter(Parameter.COMMUNITY_NETWORKS);
							List<User> users = (List<User>) binder.parameters.getParameter(Parameter.COMMUNITY_NETWORK_USERS);
							User user;
							...
							for(CommunityNetwork n : communityNets){
								if(n.getName().equals(cn.getName())){
									communityNets.remove(n);
									for(User u : users){
										if (u.getCommunityNetwork().equals(n)){
											users.remove(u);
